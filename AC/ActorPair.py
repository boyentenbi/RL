...
class ActorPair(object):
    ...
    def __init__(self, sess, state_dim, action_dim, action_bound, learning_rate, tau):
        ...
        print "There are", len(tf.trainable_variables()), "before creating main actor" 
        
        # Create the main network
        self.state, self.unscaled_action, self.action = self.create_actor_network()
        
        print "There are", len(tf.trainable_variables()), "after creating main actor" 
        ...
        print "There are", len(tf.trainable_variables()), "after creating target actor" 
